    ...
    return (
        <div>
            <div className="flex justify-evenly mb-6 mt-4">
                <h1 className="text-4xl">{cart.length}</h1>
                <h1 className="text-4xl">{Number(totalPrice)}</h1>
                <button disabled={cart.length === 0} className="btn btn-primary"><Link to='/dashboard/payment'>Pay</Link></button>
            </div>
